...
from professional.generate_lesson_media import animate_image, generate_audio, generate_image, generate_video
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        teacher_prompt = (
            "I need an illustration of a well-organized store shelf, an English audio clip "
            "explaining how to greet a customer, and a short video scene of a cashier at a "
            "checkout counter, for a customer service training module."
        )
